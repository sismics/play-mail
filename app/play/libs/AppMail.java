...
import play.libs.email.AbstractMailSystemFactory;
import play.libs.email.MailSystem;
import play.libs.email.MockMailSystem;
...
public class AppMail {
     ...
     *
     * @see    AppMail#useMailSystem(MailSystem)
     * @author Andreas Simon &lt;a.simon@quagilis.de&gt;
     */
    public static MockMailSystem Mock = new MockMailSystem();
}
